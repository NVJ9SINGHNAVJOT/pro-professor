...
| [docs/usage.md](docs/usage.md) | What the app does, surface by surface, from the user's side |
...
deleted rather than repaired. Read the code for how something works; don't write a replacement.
